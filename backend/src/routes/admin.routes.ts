...
router.patch("/bookings/:id/refunded", adminController.markBookingRefunded);
router.get("/revenue", adminController.revenue);
router.post("/revenue/settlements/generate", adminController.generateSettlement);
router.post("/revenue/payouts/:hostId/paid", adminController.markHostPayoutPaid);
