...
// @ts-nocheck 
/*
 * This file exports the `TourImage` model and its related types.
 *
...
export type GetTourImageAggregateType<T extends TourImageAggregateArgs> = {
      [P in keyof T & keyof AggregateTourImage]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTourImage[P]>
    : Prisma.GetScalarType<T[P], AggregateTourImage[P]>
}
...
export type GetTourImageGroupByPayload<T extends TourImageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TourImageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TourImageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TourImageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TourImageGroupByOutputType[P]>
      }
    >
  >
...
export type TourImageWhereInput = {
  ...
  url?: Prisma.StringFilter<"TourImage"> | string
  isPrimary?: Prisma.BoolFilter<"TourImage"> | boolean
...
export type TourImageScalarWhereWithAggregatesInput = {
  ...
  url?: Prisma.StringWithAggregatesFilter<"TourImage"> | string
  isPrimary?: Prisma.BoolWithAggregatesFilter<"TourImage"> | boolean
...
export type TourImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "url" | "isPrimary" | "tourId", ExtArgs["result"]["tourImage"]>
...
export type TourImageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TourImageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TourImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TourImage'], meta: { name: 'TourImage' } }
  /**
   ...
   * })
  **/
  count<T extends TourImageCountArgs>(
    args?: Prisma.Subset<T, TourImageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TourImageCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TourImageGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TourImageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTourImageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface TourImageFieldRefs {
  ...
  readonly url: Prisma.FieldRef<"TourImage", 'String'>
  readonly isPrimary: Prisma.FieldRef<"TourImage", 'Boolean'>
